...
const SignIn = () => {
  ...
  const handleSubmit =  async(e)=>{
    ...
    if(!UserData.email ||!UserData.password){
      dispatch(signInFailure('Please fill out all form fields'));
    }
      ...
      <div className="flex p-3 max-w-3xl mx-auto flex-col md:flex-row md:items-center gap-5">
        ...
        <div className="flex-1">
          <form className="flex flex-col gap-3" onSubmit={handleSubmit}>
            ...
            <Button type="submit" className="text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm text-center">
